class DivisionsController < ApplicationController
  ...
  private
    ...
    def division_params
      if params[:game_id].instance_of?(String)
        params[:game_id] = params[:game_id].to_i
      end
      params.require(:division).permit(:game_id, :div, :distance, :finisher, :team_rank, :num_of_team)
    end
end

...
class CollegesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create college" do
    assert_difference('College.count') do
      post colleges_url, params: { college: { abbreviation: @college.abbreviation, college: @college.college, school_id: @college.school_id } }
    end
  ...
  test "should update college" do
    patch college_url(@college), params: { college: { abbreviation: @college.abbreviation, college: @college.college, school_id: @college.school_id } }

...
class DivisionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create division" do
    assert_difference('Division.count') do
      post divisions_url, params: { division: { distance: @division.distance, division: @division.division, finisher: @division.finisher, game: @division.game, num_of_team: @division.num_of_team, team_rank: @division.team_rank } }
    end
  ...
  test "should update division" do
    patch division_url(@division), params: { division: { distance: @division.distance, division: @division.division, finisher: @division.finisher, game: @division.game, num_of_team: @division.num_of_team, team_rank: @division.team_rank } }
